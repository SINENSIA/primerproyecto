...
public class SolucionStreams {
        ...
        public static void main(String[] args) {
                ...
                animales.add(new Animal("Leon", 8, 190));
                animales.add(new Animal("Lince", 3, 25));
                animales.add(new Animal("Oso", 12, 350));
                animales.add(new Animal("Lobo", 6, 45));

                // 1. Mostrar todos los animales
                animales.stream().forEach(IO::println);
