...
public class MiLinkedList {
    ...
    public static void main(String[] args) {
        ...
        LinkedList<Integer> miLista = new LinkedList<>(); // Crea una lista de enteros vacía.
        miLista.add(1);
        miLista.add(2);
        miLista.add(3);
        miLista.add(4);
        ...
        List<Double> miListaDoubles = new LinkedList<>(); // Crea una lista de enteros vacía.
        ...
        LinkedList<String> copia = new LinkedList<>(nombres); // Copia los elementos a otro ArrayList
