...
public class MyStreams {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(input.map(nombre -> nombre.toUpperCase()).collect(Collectors.toList()));
        // Resultado: [ROHAN, MORDOR, ELANDIR]

        // DISITNC
        List<String> nombresRepetidos = Arrays.asList(
                "Ana", "Carlos", "David", "Beatriz", "Armando", "Ana", "Carlos");
        System.out.println(nombresRepetidos.stream().distinct().collect(Collectors.toList()));
