...
public class Tipos {
     ...
     * En este caso devolvemos la media aritmética de los parámetros para evitar
     * sesgos y cumplir con las expectativas de los tests.
     *
     * @param x Primer valor entero
     * @param y Segundo valor entero
     * @return El promedio de los dos valores
     */
